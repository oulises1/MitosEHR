(function() {
    ...
    var themesData = [
            {id: 'default', name: 'Theme1', file: 'sencha-touch.css'},
            {id: 'apple', name: 'Theme2', file: 'apple.css'},
            {id: 'android', name: 'Theme3', file: 'android.css'},
            {id: 'blackberry', name: 'Theme4', file: 'bb6.css'}
        ],
        themeSheets = {},
